...
import numpy
import functions
from pylatex import Document, Section, Subsection, Figure, NoEscape, Subsubsection
...
class mohr_circle():
    ...
    def solver(self):
        ...
        doc.generate_pdf('Settings\\resolucaomohr', compiler='pdflatex')
        doc.generate_tex('Settings\\resolucaomohr')
